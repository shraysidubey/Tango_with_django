...
def page(request, Page_title_slug):
    ...
    try:
        ...
        context_dict1['Page_title'] = Page.title

        pages = Page.objects.filter(Page=Page)

        context_dict1['pages'] = pages

        context_dict1['category'] = category
    except Page.DoesNotExist:

        pass
    return render(request, 'rango/category1.html', context_dict1)
